...
Οι 4 υπηρεσίες ανοίγουν σε ξεχωριστές σελίδες με ακριβώς την ίδια δομή, navigation, FAQ, Επικοινωνία και footer:

```text
/kouzines.html
/ntoulapes.html
/portes.html
/eidikes-kataskeves.html
```

Η αρχική σελίδα συνδέεται μόνο με αυτές τις canonical σελίδες.
